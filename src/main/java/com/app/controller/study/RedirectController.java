...
public class RedirectController {
	...
	public String re2(HttpServletRequest request) {
		...
		// 로직
		// request.setAttribute("msg", "re2 직접넣은 msg"); 덮어쓰기 됨
	...
	public String re4(HttpServletRequest request, RedirectAttributes ra) {
		// return "re/re2"; //view 경로 보여줌 ...../re2.jsp
		System.out.println(request.getParameter("msg"));

		request.setAttribute("msg", "re4 redirect msg"); // redirect시 안 넘어감
		ra.addAttribute("msg", "re4 redirect msg"); // 파라미터 넘기기

		// return "redirect:re/re2"; // redirect 걸면 그 경로로 다시 요청! 요청할 주소!
